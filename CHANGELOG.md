...
* Update nav settings #major by @thejmitchener in https://github.com/fuelviews/laravel-navigation/pull/29

**Full Changelog**: https://github.com/fuelviews/laravel-navigation/commits/v1.0.0

## v0.0.16 - 2024-11-13

### What's Changed

* Bump poseidon/wait-for-status-checks from 0.5.0 to 0.6.0 by @dependabot in https://github.com/fuelviews/laravel-navigation/pull/24
* Refactored composer.json description and removed unnecessary repository. Updated footer.blade.php to dynamically generate social media links and fixed some route conditions for legal links. by @thejmitchener in https://github.com/fuelviews/laravel-navigation/pull/25

**Full Changelog**: https://github.com/fuelviews/laravel-navigation/compare/v0.0.14...v0.0.16
